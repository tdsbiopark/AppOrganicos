...
import 'package:app_organicos/visao/tela_cadastro_tipoProduto.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:flutter_slidable/flutter_slidable.dart';

class TelaPesquisaTipoProduto extends StatefulWidget {
  TelaPesquisaTipoProduto({Key key}) : super(key: key);
...
class _TelaPesquisaTipoProdutoState extends State<TelaPesquisaTipoProduto> {
  ControleTipoProduto _controle = ControleTipoProduto()..atualizarPesquisa();
  Icon iconeBotaoPesquisar = new Icon(
    Icons.search,
    color: Colors.white,
  );

  Widget _appBarTitle = Text("Lista de Tipos de Produtos");
    ...
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            ...
            _controle.tipoProdutoEmEdicao = TipoProduto();
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      ...
                      TelaCadastroTipoProduto(
                          this._controle, onFinishedInsert)),
            );
          },
        ),
        ...
        body: FutureBuilder(
            ...
            future: _controle.fTipoProdutoPesquisados,
            ...
            builder: (BuildContext context, AsyncSnapshot<List> snapshot) {
              ...
              _controle.tipoProdutoPesquisados = snapshot.data;
              //Carregar a lista de objetos:
              return ListView.builder(
                //pega a quantidade de objetos
                itemCount: _controle.tipoProdutoPesquisados.length,
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return _linhaListaZebrada(
                      _controle.tipoProdutoPesquisados[index], index);
                },
              );
            }));
  }

  Widget _linhaListaZebrada(TipoProduto tipoProduto, int indice) {
    ...
    return Slidable(
        ...
        child: Container(
            ...
            child: ListTile(
              //texto da linha
              title: new Text("Nome: " + tipoProduto.nome,
                  style: TextStyle(
                      color: Colors.black,
                      fontSize: 18,
                        ...
                        new TextButton(
                            ...
                            onPressed: () {
                              ...
                              setState(() {
                                ...
                                _controle.tipoProdutoEmEdicao.ativo = false;
                                //Grava com o campo ativo = false
                                _controle.gravarTipoProdutoEmEdicao();
                                //Atualiza a lista na tela
                                setState(() {
                                  //Pega a lista, e remove o item desativado, pelo indice
                                  _controle.tipoProdutoPesquisados
                                      .removeAt(indice);
                                });
                              });
