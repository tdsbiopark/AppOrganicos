...
INSERT INTO grupo(id,nome, endereco, numero, bairro, cidade_id, cnpj, inscricao_estadual, distribuidor_produtos, registro_ativo) VALUES (1,'Cores da Terra', 'R. Maringá - Sala 1', '1968', 'Bairro São Cristóvão',3256, '32.817.675/0001-14', 'IE-1597533', 1, 1);
INSERT INTO grupo(id,nome, endereco, numero, bairro, cidade_id, cnpj, inscricao_estadual, distribuidor_produtos, registro_ativo) VALUES (1,'Cores da Terra', 'R. Maringá - Sala 1', '1968', 'Bairro São Cristóvão',3566, '32.817.675/0001-14', 'IE-1597533', 1, 1);

INSERT INTO public.produtor(
	id, certificadora_id, grupo_id, nome, nome_propriedade, cpf_cnpj, endereco, numero, bairro, cidade_id, telefone, latitude, longitude, certificacao_organicos, venda_consumidorfinal, registro_ativo)
	VALUES (1, 1, 1, 'Olaides Ferreira', 'Sitio Lua nova', '461.096.560-70', 'Endereco', '159','Bairro','3566','45-99904578','154654', '564654', 'A', 1, 1);